...
<body>
    ...
    <div class="lg:pl-64 flex flex-col">
        <main class="flex-1">
            ...
            <form action="/admin/addPromo" method="post" class="w-fit m-auto mt-24">
                <div>
                    ...
                    <div class="mt-1 border-b border-gray-300 focus-within:border-indigo-600">
                        <input type="text" name="promoName" id="promoName" class="block h-10 w-full border-0 border-b border-transparent bg-gray-50 focus:border-indigo-600 focus:ring-0 sm:text-sm" placeholder="Promo name">
                    </div>
                </div>
                ...
                <button type="submit" class="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 text-indigo-600 text-white">
                    ...
                    <span class="relative text-indigo-600 transition duration-300 group-hover:text-white ease">Add Promo</span>
                </button>
            </form>
