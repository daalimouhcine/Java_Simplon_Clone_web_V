...
<body>
        ...
        <div class="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <div class="px-3 relative inline-block text-left">
                ...
                <div>
                    ...
                    <span class="flex w-full justify-between items-center">
                          <span class="flex min-w-0 items-center justify-between space-x-3">
                                <span class="inline-flex items-center justify-center h-10 w-10 rounded-full bg-cyan-700">
                                  <span class="text-sm font-medium leading-none text-cyan-200"><%=admin.getFullname().toUpperCase().charAt(0)%></span>
                                </span>
                              <span class="flex-1 flex flex-col min-w-0">
                              <span class="text-gray-900 text-sm font-medium truncate"><%=admin.getFullname()%></span>
                              <span class="text-gray-500 text-xsm truncate"><%=admin.getEmail()%></span>
    ...
    <div class="lg:pl-64 flex flex-col">
        <main class="flex-1">
            ...
            <form action="/admin/addTeacher" method="post" class="w-fit m-auto mt-24">
                <div>
                ...
                <button type="submit" class="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 text-indigo-600 text-white">
                    ...
                    <span class="relative text-indigo-600 transition duration-300 group-hover:text-white ease">Add Teacher</span>
                </button>
            </form>
