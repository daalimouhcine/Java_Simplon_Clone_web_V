        ...
        <div class="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <nav class="px-3 mt-6">
                <div class="space-y-1">
                    ...
                    <a href="admin" class="bg-gray-200 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md" aria-current="page">
                        <svg class="text-gray-500 mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        Dashboard
                ...
                <div class="align-middle inline-block min-w-full border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tr class="border-t border-gray-200">
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">Title</th>
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">Description</th>
                            <th class="pr-6 py-3 border-b border-gray-200 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">Technologies</th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            <td class="px-6 py-3 text-sm text-gray-500">
                                <div class="truncate"><%=brief.getTitle()%></div>
                            </td>
                            <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-right"><%=brief.getDescription()%></td>
                            <td class="pr-6 py-3 whitespace-nowrap text-sm text-gray-500 text-right"><%=brief.getTechnologies()%></td>
                        </tr>
                        <%
                            }
                        %>
