                ...
                <div class="align-middle inline-block min-w-full border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tr class="border-t border-gray-200">
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Student Full Name</th>
                        ...
                        <tr>
                            <td class="px-6 py-3 text-sm text-gray-500">
                                <div class="truncate"><%=student.getFullname()%></div>
                            </td>
                            <td class="px-6 py-3 text-sm text-gray-500">
                                <div class="truncate"><%=student.getPhone()%></div>
                            </td>
                            <td class="px-6 py-3 text-sm text-gray-500">
