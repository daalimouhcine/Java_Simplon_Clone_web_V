        ...
        <div class="lg:pl-64 flex flex-col flex-1">
            ...
            <main class="flex-1 pb-8">
                ...
                <div class="mt-8">
                    ...
                    <h2 class="max-w-6xl mx-auto mt-8 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-6 lg:px-8">Assign Student</h2>
                            ...
                            <div class="flex flex-col mt-2">
                                <div class="align-middle min-w-full overflow-x-auto shadow overflow-hidden sm:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <%
                                            List<StudentsEntity> noPromoStudentList = (List<StudentsEntity>) request.getAttribute("noPromoStudentList");
                                            if(noPromoStudentList != null) {
                                                for (StudentsEntity student : noPromoStudentList) {
                                        %>
                                        <tr class="bg-white">
                                            <td class="flex px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                ...
                                                <p class="text-gray-900 font-medium"><%=student.getFullname()%></p>
                                            </td>
                                            ...
                                            <td class="">
                                                <%--                                                    button to unassign--%>
                                                <form action="/teacher/students/assign" method="post" class="m-auto">
                                                    <input type="hidden" name="action" value="assign">
                                                    <input type="hidden" name="studentId" value="<%=student.getId()%>">
                                                    <button title="Assign" type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                            ...
                                            <td class="max-w-0 w-full px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <div class="flex">
                                                    <a href="#" class="group inline-flex space-x-2 truncate text-sm">
                                                        ...
                                                        <p class="text-gray-500 truncate group-hover:text-gray-900">No student</p>
                                                    </a>
                                                </div>
                                            </td>
