            ...
            <div class="mt-8">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <% } else { %>
                            <div class="bg-white overflow-hidden shadow rounded-lg mx-auto">
                                <h3 class="text-lg leading-6 font-medium text-gray-900 m-auto">No Promo to show informations</h3>
                            </div>
                        <% } %>
